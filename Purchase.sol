...
contract Purchase {
    ...
    // Cannot call complete purchase
    error CannotCallCompletePurchase();
    ...
    modifier canCompletePurchase() {
        if(msg.sender != buyer && (block.timestamp < purchaseTimestamp + 5 minutes))
            revert CannotCallCompletePurchase();
        _;
    }
    ...
    //// Complete purchase by unlocking escrow and refunding seller
